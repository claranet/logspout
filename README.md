...
[Travis-CI](!https://travis-ci.org/claranet/logspout.svg?branch=[Travis-CI](!https://travis-ci.org/claranet/logspout.svg?branch=[Travis-CI](!https://travis-ci.org/claranet/logspout.svg?branch=[Travis-CI](!https://travis-ci.org/claranet/logspout.svg?branch=1.0.0))))
